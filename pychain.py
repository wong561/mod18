...
#input_receiver = st.text_input("Enter Sender ID")
...
# YOUR CODE HERE
input_amount = st.text_input("What Amount Do You Want To Send?")
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(sender_id=input_sender, receiver_id=input_receiver, amount=input_amount),
        creator_id=42,
